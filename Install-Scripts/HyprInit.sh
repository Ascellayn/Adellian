...
ENDL
LOG "[HyprInit] - Installing Compilation Dependencies...\n"
SEPARATE
{
...
# make cmake g++ pkg-config // Required for C++
# libegl1-mesa-dev // Required for Hyprland
# libpugixml-dev // Required for hyprwayland-scanner
# libpixman-1-dev // Required for hyprutils
# libseat-dev libinput-dev libwayland-dev wayland-protocols libdrm-dev libgbm-dev libdisplay-info-dev hwdata // Required for Aquamarine
# libzip-dev libcairo2-dev librsvg2-dev libtomlplusplus-dev // Required for hyprcursor
# libmagic-dev // Required for hyprgraphics
# libxkbcommon-x11-dev libxcursor-dev libre2-dev libxcb-present-dev libxcb-icccm4-dev libxcb-composite0-dev libxcb-res0-dev libxcb-errors-dev // Required for Hyprland
SEPARATE
